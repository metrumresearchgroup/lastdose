...
<!-- badges: start -->
[![Travis build status](https://travis-ci.org/metrumresearchgroup/lastdose.svg?branch=master)](https://travis-ci.org/metrumresearchgroup/lastdose)
<!-- badges: end -->
...
Now we have `TAD`, `LDOS`, and `TAFD` in our data set.
